...
const address = '0x19eb4c98009be5d8bcbc07520fb1871a8e348674';
const password = '123456';
var datadir = '/home/masurk/.lachesis/fakenet-1/';
let keyObject = keythereum.importFromFile(address, datadir);
const pk1 = keythereum.recover(password, keyObject);
console.log('pk1', pk1);
keyObject = {
    ...
    crypto: {
        ...
        kdf: 'scrypt',
        kdfparams: {
            dklen: 32, n: 262144, p: 1, r: 8, salt: 'a09cc7d83a86b42087e7cfe34566206daf5956f8cffee2803175739f2790cef3',
        },
...
const pk2 = keythereum.recover(password, keyObject);
